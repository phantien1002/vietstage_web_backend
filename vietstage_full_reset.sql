...
('admin@vietstage.com', '$2a$10$FPCXHRtYgKFc9yLiKREjdO88E8P2lyEbphhTLi7T/Z7OfQYtuyOim', 'System Admin', (SELECT role_id FROM roles WHERE role_name = 'ADMIN'), 'https://i.pravatar.cc/150?u=admin1', true, NOW() - INTERVAL '30 days', NOW()),
('quang@vietstage.com', '$2a$10$FPCXHRtYgKFc9yLiKREjdO88E8P2lyEbphhTLi7T/Z7OfQYtuyOim', 'Nguyễn Đăng Quang', (SELECT role_id FROM roles WHERE role_name = 'ADMIN'), 'https://i.pravatar.cc/150?u=admin2', true, NOW() - INTERVAL '20 days', NOW()),
('dantranh.master@vietstage.com', '$2a$10$FPCXHRtYgKFc9yLiKREjdO88E8P2lyEbphhTLi7T/Z7OfQYtuyOim', 'Trần Thị Thu Thủy', (SELECT role_id FROM roles WHERE role_name = 'INSTRUCTOR'), 'https://i.pravatar.cc/150?u=ins1', true, NOW() - INTERVAL '40 days', NOW()),
('saotruc.guru@vietstage.com', '$2a$10$FPCXHRtYgKFc9yLiKREjdO88E8P2lyEbphhTLi7T/Z7OfQYtuyOim', 'Lê Văn Khang', (SELECT role_id FROM roles WHERE role_name = 'INSTRUCTOR'), 'https://i.pravatar.cc/150?u=ins2', true, NOW() - INTERVAL '35 days', NOW()),
('danbau.pro@vietstage.com', '$2a$10$FPCXHRtYgKFc9yLiKREjdO88E8P2lyEbphhTLi7T/Z7OfQYtuyOim', 'Phạm Minh Trí', (SELECT role_id FROM roles WHERE role_name = 'INSTRUCTOR'), 'https://i.pravatar.cc/150?u=ins3', true, NOW() - INTERVAL '10 days', NOW()),
('learner1@gmail.com', '$2a$10$FPCXHRtYgKFc9yLiKREjdO88E8P2lyEbphhTLi7T/Z7OfQYtuyOim', 'Học Viên Một', (SELECT role_id FROM roles WHERE role_name = 'LEARNER'), 'https://i.pravatar.cc/150?u=learn1', true, NOW() - INTERVAL '5 days', NOW()),
('learner2@gmail.com', '$2a$10$FPCXHRtYgKFc9yLiKREjdO88E8P2lyEbphhTLi7T/Z7OfQYtuyOim', 'Học Viên Hai', (SELECT role_id FROM roles WHERE role_name = 'LEARNER'), 'https://i.pravatar.cc/150?u=learn2', true, NOW() - INTERVAL '2 days', NOW())
ON CONFLICT (email) DO NOTHING;
